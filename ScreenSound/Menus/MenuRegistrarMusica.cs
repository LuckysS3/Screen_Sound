...
internal class MenuRegistrarMusica : Menu
{
    public override void Executar(DAL<Artista> artistaDAL)
    {
        ...
        if (artistaRecuperado != null)
        {
            ...
            int anoLacamento =  int.Parse(Console.ReadLine()!);

            artistaRecuperado.AdicionarMusica(new Musica(tituloDaMusica, anoLacamento));
            artistaDAL.Altualizar(artistaRecuperado);
